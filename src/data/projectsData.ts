...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description:
            "Comprehensive guide for setting up a Raspberry Pi 5 as a portable and complete development environment.",
        detailedDescription:
            "This Raspberry Pi 5 Codepi Setup Guide provides a comprehensive guide for configuring your Raspberry Pi 5 to work seamlessly with an iPad Pro via USB-C Thunderbolt 4 and USB Ethernet connection. It covers SSH setup using Blink Shell, remote access through RealVNC Viewer, setting up Code-Server for a portable development environment, along other topics. This setup offers significant advantages for developers, including a stable, portable, and powerful development platform that maximizes productivity and flexibility.",
    ...
    },
    {
        ...
        detailedDescription:
            "SpaceInvaders is an action-packed arcade game, developed using Java Swing, and inspired by the original Space Invaders. This project showcases advanced game development techniques, including real-time rendering, collision detection, and comprehensive game state management, delivering a modern take on the classic space shooter genre. It introduces varied alien types with unique scoring impacts, adding depth to gameplay diversity.",
        image: "/main_projects/spaceInvaders.png",
